...
namespace InkStudio.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,Nome,Email,Dt_nasci,Telefone")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,Nome,Email,Dt_nasci,Telefone")] Cliente cliente)
        {
